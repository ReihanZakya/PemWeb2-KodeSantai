...
<body class="mybg-blue">
  <div class="container justify-content-center d-flex align-items-center"  style="height: 100vh">
    <div class="card o-hidden border-0 shadow-lg border border-success my-5 ">
      <div class="card-body p-0 border border-warning">
        <!-- Nested Row within Card Body -->
        <div class="row " >
          <div class="col-lg-5 d-none d-lg-flex  text-center justify-content-center align-items-center bg-register-image">
            <img class="align-center" src={{ 'images/programmer.png' }} alt="" width="70%" height="">
          </div>
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <form action="{{ route('register.save') }}" method="POST" class="user">
                ...
                <button type="submit" class="btn myBtn-blue btn-user btn-block">Register Account</button>
              </form>
